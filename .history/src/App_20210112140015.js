              ...
              <AnimationWrapper className="hoverwidthcards">
                <Card id="Top-cards">
                  <CardImg
                    ...
                    width="100%"
                    height="100%"
                    src="https://tattoodo-web.imgix.net/misc/52.jpg?auto=format,compress&w=750"
                  />
                </Card>
              </AnimationWrapper>
            </Col>
      ...
      <div className="section3" id="section3">
        <Col md="12">
          <Row>
            ...
            >
              <Card  className="tatosdescription" style={{ borderColor: "transparent" }}>
            ...
            <Col md="6" className="colheight" style={{ padding: 30,backgroundColor:'red' }}>
              <div
                className="video"
                style={{
                  position: "relative",
